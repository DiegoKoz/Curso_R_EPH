...
subtitle: "Datos de la Encuesta Permanente de Hogares. 1er trimestre de 2017."
...
```{r message=FALSE, warning=FALSE, include=FALSE}
# Directorios: En la carpeta donde está el script, tenemos que tener una carpeta de Fuentes con las bases y otra vacía de Graficos.
script.dir <- dirname(rstudioapi::getActiveDocumentContext()$path)
fuentes.dir <- paste0(dirname(script.dir), "/Fuentes/")
graficos.dir <- paste0(dirname(script.dir), "/Resultados/")

# Se levantan las bases usuarias de la EPH del trimestre correspondiente
base_individual <- read.table(paste0(fuentes.dir, "usu_individual_t117.txt"), sep=";", dec=",", header = TRUE, fill = TRUE)
base_hogar <- read.table(paste0(fuentes.dir, "usu_hogar_t117.txt"), sep=";", dec=",", header = TRUE, fill = TRUE)
```
...
ggsave(paste0(graficos.dir, "Grafico1.png"), scale = 2)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# Aquí hay que cambiar el directorio en que se va a guardar el gráfico.
ggsave(paste0(graficos.dir, "Grafico2.png"), scale = 2)
```
...
```{r, message=FALSE, warning=FALSE, include=FALSE}
ggsave(paste0(graficos.dir, "Grafico3.png"), scale = 2)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggsave(paste0(graficos.dir, "Grafico4_ms.png"), scale = 2)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggsave(paste0(graficos.dir, "Grafico5_ms.png"), scale = 2)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggsave(paste0(graficos.dir, "Grafico6_hr.png"))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggsave(paste0(graficos.dir, "Grafico7_hr.png"), scale = 2)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
ggsave(paste0(graficos.dir, "Grafico8.png"), scale = 3)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
ggsave(paste0(graficos.dir, "Grafico9.png"), scale = 3)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
ggsave(paste0(graficos.dir, "Grafico10.png"), scale = 1)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
ggsave(paste0(graficos.dir, "Grafico11.png"), scale = 1)
```
